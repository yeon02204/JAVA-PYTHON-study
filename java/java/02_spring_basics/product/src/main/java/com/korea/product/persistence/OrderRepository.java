...
public interface OrderRepository extends JpaRepository<OrderEntity, Integer>{
	...
	@Query("SELECT o.orderId, o.product.productName, o.productCount, o.product.productPrice, (o.productCount * o.product.productPrice) AS totalPrice, o.orderDate FROM OrderEntity o")
